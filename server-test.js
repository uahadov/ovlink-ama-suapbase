...
const ASSET_VERSION = (process.env.ASSET_VERSION || process.env.RENDER_GIT_COMMIT || '').toString().trim() || '20260814-12';
...
app.use((req,res,next)=>{ req.session = { adminUserId: 1, adminEmail: 'test@test.com', adminRole: 'admin' }; next(); }); app.use('/admin', createAdminRouter(db, {
