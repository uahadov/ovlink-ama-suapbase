/**
 * TEMPORARY DEBUG SCRIPT — Exact signature reconstruction test
 * Paste the EXACT raw body from Polar and see if we can reproduce the expected sig.
 * Run: node test-webhook-sig2.js
 */
