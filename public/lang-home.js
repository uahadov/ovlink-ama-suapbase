const homeTranslations = {
  az: {
    ...
    qr_alias_placeholder: "Qısa link (məs: abc123)",
    ...
    home_mini_feature_1_text: "URL daxil edin və dərhal qısa kod alın.",
    home_mini_feature_2_title: "Məxfilik Mərkəzli Statistika",
    home_mini_feature_2_text: "Yalnız vacib statistikalar toplanır.",
    home_mini_feature_3_title: "Daxili Təhlükəsizlik",
    home_mini_feature_3_text: "Moderasiya və report axını təhlükəsizliyi qoruyur.",
    home_mini_feature_4_title: "Yaxşı UX",
    home_mini_feature_4_text: "Bütün cihazlarda sürətli və mobil-uyğun təcrübə.",
  ...
  tr: {
    ...
    alias_placeholder: "Özel ad (isteğe bağlı)",
    pass_placeholder: "Şifre (isteğe bağlı)",
    ...
    qr_alias_placeholder: "Kısa link (ör: abc123)",
    ...
    home_mini_feature_1_text: "URL girin ve hemen kısa kod alın.",
    home_mini_feature_2_title: "Gizlilik Odaklı Analitik",
    home_mini_feature_2_text: "Sadece gerekli metrikler toplanır.",
    home_mini_feature_3_title: "Yerleşik Güvenlik",
    home_mini_feature_3_text: "Moderasyon ve bildirim akışı güvenliği korur.",
    home_mini_feature_4_title: "Güçlü UX",
    home_mini_feature_4_text: "Tüm cihazlarda hızlı ve mobil uyumlu deneyim.",
  ...
  en: {
    ...
    home_mini_feature_1_text: "Paste your URL and get a short code instantly.",
    home_mini_feature_2_title: "Privacy-First Analytics",
    home_mini_feature_2_text: "Only essential stats are collected for insights.",
    home_mini_feature_3_title: "Safety Built-in",
    home_mini_feature_3_text: "Moderation and reports help keep links safe.",
    home_mini_feature_4_title: "Great UX",
    home_mini_feature_4_text: "Fast and mobile-friendly experience on every page.",
