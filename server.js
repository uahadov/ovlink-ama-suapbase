      ...
      Promise.all([
        ...
        checkCustomDomain((domainErr, selectedDomain) => {
          ...
          async function insertLink(selectedDomainHost) {
            ...
            db.run(
              'INSERT INTO urls (original, short, created_at, user_id, link_password, expires_at, max_clicks, domain_host, workspace_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)',
              [originalAbs, short, createdAt, ownerId, storedLinkPassword, expiresAtValue, maxClicksValue, selectedDomainHost || null, workspaceLinkScopeId],
              function (err) {
